...
<body>
	...
	<section id="section">
		<div class="section">
			<div class="main">
				<button onclick="location.href='../jsp/content.jsp'">글쓰기</button>
				<div id="qnalist">
				<span class="qnalist"><a href="">Java</a></span>
				<span class="qnalist"><a href="">SQL</a></span>
				<span class="qnalist"><a href="">Front</a></span>
				<span class="qnalist"><a href="">SpringBoot</a></span>
				</div>
				<button class="qnaselect"><select>
					<option>최신순</option>
					<option>조회수순</option>
				</select></button>
			</div><hr/>
